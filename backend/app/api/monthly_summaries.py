...
def get_monthly_summaries(
    ...
    summaries = (
        ...
        .filter(MonthlySummary.user_id == current_user.id, MonthlySummary.year == year)
...
def recalculate_single_month(
    ...
    try:
        ...
        aggregated = (
            db.query(Category.type, func.sum(Transaction.amount))
            .join(Category, Transaction.category_id == Category.id)
            .filter(
